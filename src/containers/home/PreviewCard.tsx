      ...
      <Box borderRadius="10px" bgColor="gray.100" height="fit-content">
        ...
        <Box maxH="50rem" overflowY="auto" px="24px" pb="24px">
          ...
          <DataCard title="Job Detail">
            <KeyValue title="Job Title" values={jobDetails?.jobTitle} />
            <KeyValue title="Job Details" values={jobDetails?.jobDetails} />
            <KeyValue title="Job Location" values={jobDetails?.jobLocation} />
          </DataCard>
